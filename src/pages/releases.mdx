...
>
  <StandardLayout class="max-w-65ch" isCentered={true}>
    <Fragment slot="head">
      ...
      >Display your GitHub releases using <Link href="https://github.com/lin-stephanie/astro-loaders/tree/main/packages/astro-loader-github-releases" external={true}>astro-loader-github-releases</Link></p>
    </Fragment>
